...
<html>
	<head>
		...
		<script type="text/javascript" src="/wyu34coin/1/Public/Js/jquery.min.js" ></script>
     ...
     popupDialogObj.popup({
         afterclose: function (event, ui) {
            popupDialogObj.find(".optionConfirm").first().off('click');
             ...
             if (isConfirmed) {            	
                $.post(
   	     	 	"/wyu34coin/1/index.php/Home/User/receiveCoinText",
   	     	 	formData
     ...
     // jQuery.mobile.ajaxEnabled = false; 
		...
		//表单提交 ，完善信息
           $("#submit").click(function(){     
                ...
                $.ajax({  
                    type: "POST",  
                    url: "/wyu34coin/1/index.php/Home/User/doRenew",  
                    cache: false,  
                    data: formData,  
   	    	...
   	    	var $date=$("span#nowRecord").text(); //把日期带过去  	
   	    	 if($coinDayDes&&$coinAttr!="readonly") {
                 ...
                 formData=formData+"&date="+$date;
   	    		 $.post(
   	     	 	"/wyu34coin/1/index.php/Home/User/saveCoinDayDes",
   	     	 	formData,
	...
	<body>
		...
		<div data-role = "page" id="record">
			<div data-role="header">
				<a href="/wyu34coin/1/index.php/Home/User/homePage?opid=<?php echo ($opid); ?>" data-ajax="false" data-transition="slide" data-direction="reverse" data-icon="arrow-l">返回</a>
				<h1>记录今天 30min = one coin</h1>
			</div>
			<div data-role="content">
				<center>现在是<?php echo ($date); ?><br />
				您正在记录:<span id="nowRecord"><?php echo ($date2); ?></span>的时间
				<form>
	          ...
	          <div data-role="collapsible">
				  <h1>今日小结</h1>
				   <form id="coinDayDes" action='/wyu34coin/1/index.php/Home/User/receiveCoinText' method='post'>
